...
public class EnemySpawner : MonoBehaviour
{
    ...
    [SerializeField] private bool spawnFromPortal = true;
    [SerializeField] private float portalPosOffsetMin = -1f;
    [SerializeField] private float portalPosOffsetMax = 1f;
    ...
    private void DoSpawnEnemy(int SpawnIndex)
    {
        ...
        if (poolableObject != null)
        {
            ...
            {
                Vector3 portalPos = this.gameObject.transform.position;
                enemy.Agent.Warp(new Vector3(portalPos.x + Random.Range(portalPosOffsetMin, portalPosOffsetMax), portalPos.y, portalPos.z));
                // enemy needs to get enabled and start chasing now.
                enemy.Movement.Player = Player;
